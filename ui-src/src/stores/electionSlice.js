...
export const createElectionSlice = (set) => ({
  elections: [], // Regular campaign elections
  // CORRECTED: Moved these to top-level state
  simulatedElections: [], // Stores elections generated by the simulator
  isSimulationMode: false, // Flag to indicate if ElectionNightScreen should use simulated data
  ...
  setSimulatedElections: (electionsData) => {
    set({ simulatedElections: electionsData });
  },
  setIsSimulationMode: (mode) => {
    set({ isSimulationMode: mode });
  },
  clearSimulatedElections: () => {
    set({ simulatedElections: [], isSimulationMode: false });
  },
});
