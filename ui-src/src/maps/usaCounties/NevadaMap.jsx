  ...
  return (
    <>
      <svg
        ...
        viewBox="0 0 810 810"
        className="interactive-japan-map nevada-map"
        preserveAspectRatio="xMidYMid meet"
      >
        <g id="nevada-counties-group" stroke="white" strokeWidth="1">
