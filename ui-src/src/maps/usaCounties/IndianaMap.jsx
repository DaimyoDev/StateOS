...
const countyPathData = {
  ...
  Randolph:
    "m 585.09,292.09 30.72,-1.14 32.6,-1.02 0.48,60.79 -12.57,0.06 -35.86,1.27 -11.45,0.18 -1.84,0.07 -0.44,-14.44 z",
  Marshall:
  ...
  Floyd:
    "m 465.68,670.34 5.99,-0.16 0.01,1.48 4.4,1.39 24.93,-0.46 -0.03,0.74 7.51,9.9 -2.87,1.56 -2.25,3.61 0.58,7.37 2.96,0.4 1.82,2.68 3.17,0.77 8.92,-5.63 4.34,-5.72 2.49,-8.02 0.81,-6.33 2.2,-6.15 4.98,-4.81 9.57,-1.66 4.03,-2.18 4.86,-8.57 6.88,-4.53 0.93,-6.12 -2.08,-4.5 -7.85,0.17 -2.79,-1.15 -0.08,-2.89 -11.47,-0.31 z",
  Noble:
...
function IndianaMap({ onSelectCounty, selectedCountyGameId }) {
