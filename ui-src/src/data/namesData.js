...
export const ENGLISH_LAST_NAMES = [
  ...
  "Davis",
  "Miller",
  "Garcia", // Common in the US, reflecting English-speaking contexts
  "Rodriguez", // Common in the US
  "Martinez", // Common in the US
  "Hernandez", // Common in the US
  "Lopez", // Common in the US
  "Gonzalez", // Common in the US
  "Perez", // Common in the US
  "Taylor",
  "Anderson",
  "Moore",
  "Martin",
